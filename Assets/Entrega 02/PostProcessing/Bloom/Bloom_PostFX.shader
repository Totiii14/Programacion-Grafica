...
Shader "Bloom_PostFX"
{
	Properties
	{
		...
		_Vector1("Vector 1", Vector) = (0.002,0,0,0)
		_Float1("Float 1", Float) = 4
		_Vector2("Vector 2", Vector) = (-0.002,0,0,0)
		_Vector3("Vector 3", Vector) = (0,0.002,0,0)
		_Vector4("Vector 4", Vector) = (0,-0.002,0,0)
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				finalColor = ( ( ( tex2D( _MainTex2, ( temp_output_24_0 + float4( _Vector1, 0.0 , 0.0 ) ).rg ) + tex2D( _MainTex2, ( temp_output_24_0 + float4( _Vector2, 0.0 , 0.0 ) ).rg ) + tex2D( _MainTex2, ( temp_output_24_0 + float4( _Vector3, 0.0 , 0.0 ) ).rg ) + tex2D( _MainTex2, ( temp_output_24_0 + float4( _Vector4, 0.0 , 0.0 ) ).rg ) ) / _Float1 ) + tex2DNode19 );
...
/*ASEBEGIN
Version=18900
184;73;798;658;3955.178;1720.373;3.088432;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;15;-3063.258,-791.8591;Inherit;True;Property;_MainTex2;_MainTex2;3;0;Create;True;0;0;0;False;0;False;d4236e6a5410e2b40a90f166463499d1;d94d31337019e9142a88b694c3b1d142;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;37;-2995.712,-954.4533;Inherit;False;Property;_Vector4;Vector 4;10;0;Create;True;0;0;0;False;0;False;0,-0.002;0,-0.002;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;35;-2999.543,-1177.144;Inherit;False;Property;_Vector2;Vector 2;8;0;Create;True;0;0;0;False;0;False;-0.002,0;-0.002,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;34;-2999.022,-1288.405;Inherit;False;Property;_Vector1;Vector 1;6;0;Create;True;0;0;0;False;0;False;0.002,0;0.002,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;36;-2995.191,-1065.714;Inherit;False;Property;_Vector3;Vector 3;9;0;Create;True;0;0;0;False;0;False;0,0.002;0,0.002;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1391.248,-455.4014;Inherit;False;Property;_Float1;Float 1;7;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3A048F3F93AC7DAFDDF15FD59E7584632A3572BB