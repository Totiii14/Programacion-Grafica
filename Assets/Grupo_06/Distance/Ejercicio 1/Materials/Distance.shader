...
Shader "Distance"
{
	Properties
	{
		...
		_Deformacion("Deformacion", Vector) = (0,4,0,0)
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 temp_output_11_0 = ( temp_output_9_0 * _Deformacion * _Altura );
			v.vertex.xyz += float3( temp_output_11_0 ,  0.0 );
			v.vertex.w = 1;
			v.normal = float3( temp_output_11_0 ,  0.0 );
		}
...
/*ASEBEGIN
Version=18900
356;73;604;707;770.8367;618.2253;2.100936;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-411.9427,238.3304;Inherit;False;Property;_Frecuencia;Frecuencia;6;0;Create;True;0;0;0;False;0;False;5.59;3.42;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;15;101.8066,-315.2233;Inherit;False;Property;_Color0;Color 0;7;0;Create;True;0;0;0;False;0;False;0.2971698,1,0.890738,0;0,0.1666663,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;20;-62.80671,286.1901;Inherit;False;Property;_Deformacion;Deformacion;8;0;Create;True;0;0;0;False;0;False;0,4;0,4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;13;-60.02466,505.4158;Inherit;False;Property;_Altura;Altura;10;0;Create;True;0;0;0;False;0;False;3.72;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;222.7753,295.4158;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=1B2DEC939F389854F2596526468CF720FD211153