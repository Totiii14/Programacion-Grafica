...
Shader "Pasto"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 appendResult18 = (float4(( ase_vertex3Pos.z * 0.0 ) , 0.0 , 0.0 , 0.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 appendResult10 = (float4(break11.r , break11.g , break11.b , ( 1.0 - dotResult5 )));
...
/*ASEBEGIN
Version=18900
220;81;545;736;1529.241;1433.665;4.393377;False;False
...
Node;AmplifyShaderEditor.PosVertexDataNode;13;-924.9775,556.2977;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BreakToComponentsNode;14;-647.3445,556.9397;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
ASEEND*/
//CHKSM=323E9FA2DD73C4E16EB2EF8EB31AB614238B2380