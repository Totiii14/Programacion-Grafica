...
Shader "Ventana"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float mulTime38 = _Time.y * 3.0;
			float mulTime25 = _Time.y * 3.0;
			float4 appendResult36 = (float4(( 0.0 * mulTime38 ) , ( -0.1 * mulTime25 ) , 0.0 , 0.0));
			o.Albedo = tex2D( _TextureSample1, ( (ase_screenPosNorm).xyzw + appendResult36 ).xy ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
58;611;1904;980;3109.427;-179.2584;1.6;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;38;-2563.817,676.169;Inherit;False;1;0;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;25;-2559.915,853.7661;Inherit;False;1;0;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-2547.164,764.2608;Inherit;False;Constant;_MoveY;MoveY;5;0;Create;True;0;0;0;False;0;False;-0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-2542.091,584.6545;Inherit;False;Constant;_MoveX;MoveX;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-2360.012,751.9569;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-2359.718,651.4688;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;36;-2189.255,689.9733;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;27;-2223.346,857.4979;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;37;-1990.386,697.2883;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=A79206D375C05FCB9C40960D9EF82F964DE8FBAB